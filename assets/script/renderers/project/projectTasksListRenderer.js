        ...
        <div class="tk-card-head">
            ...
            <div class="tk-dropdown" onmouseleave="this.querySelector('.tk-dropdown-menu')?.classList.remove('show')">
                ...
                <div id="dropdown-task-${t.id}" class="tk-dropdown-menu">
                    <button type="button" onclick="event.stopPropagation(); openModal('modal-task-modify-${t.id}')">
                        <i class="ti ti-pencil"></i> ${__t('edit')}
                    </button>
                    <button type="button" onclick="event.stopPropagation(); duplicateTask('${t.id}')">
                        <i class="ti ti-copy"></i> ${__t('duplicate')}
                    </button>
                    <button type="button" onclick="event.stopPropagation(); BecomeCoWorker('${t.id}')">
                        <i class="ti ti-user-plus"></i> ${__t('become co worker')}
                    </button>
                    <div class="dropdown-divider"></div>
                    <button type="button" class="danger" onclick="event.stopPropagation(); deleteTask('${t.id}')">
