  ...
  if (!$pref) {
    ...
    echo json_encode([
      ...
      $formattedLang = array_map(function($p) {
        ...
        $formattedPref = array_map(function($p) {
          return [
                  'theme_id'           => $p['tup_theme_id'],
                  'theme'         => $p['rth_label'],
                  'langue_id'          => $p['tup_langue'],
                  'langue'  => $p['lang_code'],
                  'langue_label'        => $p['lang_label'],
                  'notif_email'          => $p['tup_notif_email'],
                  'notif_mention'    => $p['tup_notif_mention'],
                  'notif_assignation' => $p['tup_notif_assignation'],
                  'notif_commentaire' => $p['tup_notif_commentaire']
          ];
        }, $pref);
