...
try{
    $db = getDB();
    $delete_user = $db->prepare("update TOG_USERS set use_mot_de_passe='0',use_role_id=3,use_email=null where use_id=?");
    ...
    echo json_encode(['success' => false, 'message' => 'Impossible de supprimer le compte'.$e]);
}
