...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-section">
        ...
        <a class="sb-item" href="../app/notifications.php"><i class="ti ti-bell" aria-hidden="true"></i><?= __tphp('notifications') ?><span class="sb-badge">3</span></a>
        <a class="sb-item" href="../app/calendar.php"><i class="ti ti-calendar" aria-hidden="true"></i><?= __tphp('calendar') ?></a>
    </div>
    ...
    <div class="sb-section">
        ...
        <a class="sb-item" href="../app/home.php?tab=myprojects"><i class="ti ti-folder" aria-hidden="true"></i><?= __tphp('my projects') ?></a>
        <a class="sb-item" href="../app/home.php?tab=contributions"><i class="ti ti-users" aria-hidden="true"></i><?= __tphp('contributions') ?></a>
        <a class="sb-item" onclick="openModal('modalNewProject')"><i class="ti ti-circle-plus" aria-hidden="true"></i><?= __tphp('new project') ?></a>
    </div>
    ...
    <div class="sb-section">
        ...
        <a class="sb-item" href="../app/home.php?tab=mytasks"><i class="ti ti-checklist" aria-hidden="true"></i><?= __tphp('my tasks') ?></a>
    ...
    <div class="sb-section">
        ...
        <a class="sb-item" href="../app/stats.php"><i class="ti ti-chart-bar" aria-hidden="true"></i><?= __tphp('statistics') ?></a>
        <a class="sb-item" href="../app/reports.php"><i class="ti ti-report" aria-hidden="true"></i><?= __tphp('reports') ?></a>
    </div>
    ...
    <div class="sb-section">
      ...
      <a class="sb-item" href="../auth/logout.php"><i class="ti ti-logout" aria-hidden="true"></i><?= __tphp('logout') ?></a>
        <a class="sb-item" href="../quicklinks/help.php"><i class="ti ti-help" aria-hidden="true"></i><?= __tphp('help') ?></a>
    </div>
</aside>
