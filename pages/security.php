<div class="profile-page">
    <div class="profile-block">
        ...
        <form class="profile-form" id="profileForm" onsubmit="event.preventDefault();">
            ...
            <div class="profile-row-2">
                <div class="profile-field">
                    ...
                    <input type="password" id="mdp-nouveau" name="mdp_nouveau"
                           placeholder="<?= __tphp('new password') ?>" autocomplete="new-password"
                           minlength="8" required>
                </div>
                <div class="profile-field">
                    <label for="mdp-confirm"><?= __tphp('confirm') ?></label>
                    <input type="password" id="mdp-confirm" name="mdp_confirm"
                           placeholder="<?= __tphp('confirm password') ?>" autocomplete="new-password" required>
                </div>
            </div>
